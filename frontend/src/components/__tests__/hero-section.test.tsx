...
describe("HeroSection", () => {
  ...
  it("renders the hero section with all main elements", () => {
    ...
    expect(
      screen.getByText(/Building scalable, intelligent systems/),
    ).toBeInTheDocument();
  ...
  it("displays animated text rotation", async () => {
    ...
    const visibleText = animatedTexts.find((text) => screen.queryByText(text));
  ...
  it("renders social links with correct hrefs", () => {
    ...
    expect(linkedinLink).toHaveAttribute(
      "href",
      "https://linkedin.com/in/sagarneeli",
    );
