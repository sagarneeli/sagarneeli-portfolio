              ...
              <div key={index} className="relative py-8">
                <div className="relative flex items-start space-x-3">
                  <div className="relative">
                    <span className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-200 dark:bg-gray-700 text-lg font-semibold text-gray-700 dark:text-gray-200 ring-8 ring-white dark:ring-gray-900">
